...
//@Autonomous(name = "AutoWorlds", group = "Auto")
            ...
            switch (mCurrentState) {
                ...
                case Lander_to_Depot:
                    ...
                    if (Vucam.sample == Vucam.sample.LEFT) {
                        ...
                        Drive.TimeDelay(0.1);
                        Drive.forwardUntilDistance(0.3, 8);
                ...
                case Double_Sample:
                    ...
                    telemetry.update();
                    if (Vucam.sample == Vucam.sample.LEFT) {
                        Drive.turn2Angle4time(TURN_SPEED, -60, 4);
                        Claimer.reset();
                        Drive.TimeDelay(0.1);
                        ...
                        Drive.turn2Angle4time(TURN_SPEED, -90, 4);
                        Claimer.reset();
                        Drive.TimeDelay(0.1);
                        ...
                        Drive.turn2Angle4time(TURN_SPEED, -120, 4);
                        Claimer.reset();
                        Drive.TimeDelay(0.1);
                        Drive.moveBackward(0.8, 0.45);
                        Drive.TimeDelay(0.1);
